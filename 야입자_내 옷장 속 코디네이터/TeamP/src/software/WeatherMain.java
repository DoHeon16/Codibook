...
public class WeatherMain {
	...
	public static void main(String[] args) {
		List<Map<String,Object>> list = getXml("서울 광진구 화양동");
	...
	try {
        File forwrite = new File("Weather.txt"); //텍스트파일명은 유저가 임의로 저장할 수 있게 나중에 변경
	...
	public static List<Map<String, Object>> getXml(String locate) {
		...
		//위에서 얻은 위도 경도를 토대로 GridX, GridY좌표를 구한다. 
		Map<String, Object> map = getGridxy(v1, v2);
		
		String xml = "";
		//GridX, GridY 좌표를 가지고 XML데이터를 가져온다.
		try {
			// 전국 날씨 정보
	...
	public static Map<String, Object> getGridxy(double v1, double v2) {
		double RE = 6371.00877; // 지구의 반경(km)
		double GRID = 5.0; // 격자 간격(km)
		double SLAT1 = 30.0; // 투영 위도1(degree)
		double SLAT2 = 60.0; // 투영 위도2(degree)
		double OLON = 126.0; // 기즌점 경도(degree)
